...
class DocumentIntelligenceController(http.Controller):
    ...
    def _type_data(self, document_type):
        ...
        return {
            ...
            "require_upload_approval": document_type.require_upload_approval,
            "require_issue_date": document_type.require_issue_date,
            "require_description": document_type.require_description,
            "enable_versioning": document_type.enable_versioning,
            "duplicate_detection_mode": document_type.duplicate_detection_mode
            or "inherit",
            "approval_flow": document_type.approval_flow or "any",
