...
class DocumentUICreation(http.Controller):
    ...
    @http.route('/api/create-folder', type='json', auth='user', methods=['POST'], csrf=False)
    def create_folder(self, **kwargs):
        ...
        try:
            ...
            folder = request.env['doc.folder'].sudo().create({
                'folder_name': name,
    ...
    def getfolder(self, id=None, **kwargs):
        ...
        Folder = request.env['doc.folder'].sudo()
    ...
    def view_folder(self, id, **kwargs):
        ...
        folder = request.env['doc.folder'].sudo().browse(id)
    ...
    def update_folder(
        ...
        **kwargs
        ...
        try:
            folder = request.env['doc.folder'].sudo().browse(int(id))
