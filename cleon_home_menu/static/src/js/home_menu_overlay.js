  ...
  var HMO = {
    ...
    build: function () {
      ...
      var html = [
        ...
        "      </a>",
        '      <a href="/web#action=69&model=res.users">',
        '        <i class="fa fa-arrow-left"></i> Settings',
        "      </a>",
        '      <a href="/web?debug=1#action=29">',
        '        <i class="fa fa-arrow-left"></i> Menus',
        "      </a>",
        '      <a href="/web#action=base.open_module_tree">',
        '        <i class="fa fa-arrow-left"></i> apps',
        "      </a>",
    ...
    _bindUI: function () {
      ...
      $(document).on("click", ".hmo-backdrop", function () {
        self.close();
      });
      ...
      this.categories.forEach(function (cat) {
        ...
        cat.app_items.forEach(function (app) {
          var iconHtml = app.icon
            ...
            : "";
          var features =
            app.children && app.children.length ? app.children.length : 1;
          ...
          var $card = $(
            '<a href="' +
              ...
              app.id +
              '">' +
              '  <div class="hc-app-icon-wrap" style="background-color:' +
              hexToRgba(cat.color, 0.1) +
              ';">' +
              iconHtml +
              '    <div class="hc-app-icon-fallback" style="color:' +
              cat.color +
              ";" +
              ...
              '    <span class="hc-app-name">' +
              $("<span>").text(app.name).html() +
              "</span>" +
              '    <span class="hc-app-desc">' +
              $("<span>")
    ...
    _applyFilter: function (term) {
      ...
      $sections.each(function () {
        ...
        $section.find(".hc-app-card").each(function () {
          ...
          var matches =
            !term || name.indexOf(term) !== -1 || desc.indexOf(term) !== -1;
      ...
      document.addEventListener(
        ...
        function (e) {
          var btn = e.target.closest(
            'button[title="Home Menu"], a[title="Home Menu"]',
          );
          if (!btn) return;
          e.preventDefault();
