...
export default function RolesView({ embedded = false }: { embedded?: boolean }) {
  ...
  async function handleSave() {
    ...
    try {
      ...
      setNotice("Social Gallery roles updated successfully.");
    } catch (error) {
      ...
      {!embedded ? (
        <div className="roles-admin-header">
          <div>
            ...
            <h1>Social Gallery roles</h1>
            <p>Assign Manager and Administrator responsibilities for Social Gallery.</p>
          </div>
          <button
            type="button"
        ...
        <div className="roles-admin-toolbar">
          <p>Assign Manager and Administrator roles for Social Gallery.</p>
          <button
            type="button"
            className="primary-button"
            onClick={handleSave}
