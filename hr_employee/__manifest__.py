# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'data/hr_benefit_data.xml',
        'data/hr_tax_status_data.xml',
        ...
        'views/hr_employee_benefit.xml',
        'views/hr_tax_status.xml',
        'views/hr_reporting_structure_view.xml',
    ...
    'assets': {
        'web.assets_backend': [
            'hr_employee/static/src/css/hr_organisation.css',
            'hr_employee/static/src/css/hr_employee.css',
            'hr_employee/static/src/css/hr_employee_form.css',
            'hr_employee/static/src/css/hr_department.css',
            'hr_employee/static/src/css/benefit_form.css',
