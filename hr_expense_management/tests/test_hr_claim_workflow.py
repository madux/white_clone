...
class TestHrClaimWorkflow(TransactionCase):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.group_employee = cls.env.ref("hr_expense_management.group_hr_expense_employee")
        cls.group_manager = cls.env.ref("hr_expense_management.group_hr_expense_manager")
        cls.group_finance = cls.env.ref("hr_expense_management.group_hr_expense_finance")
    ...
    def test_roles_and_record_visibility(self):
        ...
        self.assertFalse(
            self.manager_user.has_group("hr_expense_management.group_hr_expense_employee")
        )
        self.assertFalse(
            self.finance_user.has_group("hr_expense_management.group_hr_expense_employee")
        )
