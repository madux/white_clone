...
class HrWarningInterimmeasure(models.Model):
    _name = 'hr.warning.interim_measure'
    ...
    expected_end_date = fields.Datetime(
    ...
    measure_type_suspension_pending = fields.Boolean(
        string="Suspension Pending Investigation",
    )
    ...
    remote_work_restriction = fields.Boolean(
        string="Remote Work Restriction",
    )

    report_restriction = fields.Boolean(
        string="Report Restriction",
    )

    id_seize = fields.Boolean(
        string="ID/CARD SEIZURE",
    )

    system_access_restrict = fields.Boolean(
        string="System_access restrict",
    )

    payroll_impact_note = fields.Text(
        string="Payroll impact Note",
    )
    authorization_note = fields.Text(
        string="Authorization Note",
    )
    pay_status_id = fields.Many2one(
         'pay.status',
        string='Pay Status', 
    )
    pay_status_description = fields.Text(
        string="Pay status description",
        related="pay_status_id.description"
    )
