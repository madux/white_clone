/* ═══════════════════════════════════════════════════════════
   CleonHR Cleon Time (Claims) — cleon-time-claims.js
...
function initCtaArrowAnimation() {
    var heroCta = document.querySelector('.clt-btn-primary');
    if (heroCta) {
...
function initSmoothScroll() {
    var ctaBtn = document.querySelector('.clt-btn-white');
    if (ctaBtn) {
        ctaBtn.addEventListener('click', function (e) {
            var banner = document.querySelector('.clt-cta');
            if (banner) {
                e.preventDefault();
