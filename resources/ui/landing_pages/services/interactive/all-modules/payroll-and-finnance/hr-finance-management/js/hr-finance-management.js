/* ═══════════════════════════════════════════════════════════
   CleonHR HR Finance Management — hr-finance-management.js
...
function initCtaArrowAnimation() {
    var heroCta = document.querySelector('.hrf-btn-primary');
    if (heroCta) {
...
function initSmoothScroll() {
    var ctaBtn = document.querySelector('.hrf-btn-white');
    if (ctaBtn) {
        ctaBtn.addEventListener('click', function (e) {
            var banner = document.querySelector('.hrf-cta');
            if (banner) {
                e.preventDefault();
