/* ═══════════════════════════════════════════════════════════
   CleonHR Journal Entries — journal-entries.js
...
function initCtaArrowAnimation() {
    var heroCta = document.querySelector('.je-btn-primary');
    if (heroCta) {
...
function initSmoothScroll() {
    var ctaBtn = document.querySelector('.je-btn-white');
    if (ctaBtn) {
        ctaBtn.addEventListener('click', function (e) {
            var banner = document.querySelector('.je-cta');
            if (banner) {
                e.preventDefault();
